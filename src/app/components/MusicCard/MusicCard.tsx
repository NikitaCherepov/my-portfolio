        ...
        <div className={styles.container}>
            ...
            <div className={styles.container__allMusic}>
                    ...
                    {music.map((track) => (
                        <SwiperSlide key={track.id} className={styles.allMusicSlide}>
                            <img
                                ...
                                onClick={() => setCurrenMusicCard(track)}
                            />
                        </SwiperSlide>
                    ))}
                </Swiper>
                ...
                <div className={styles.navSlider}>
                                    <div ref={prevRef} className={`${styles.customNav} ${styles.customPrev}`}>
                    <img src="/images/icons/musiccard/arrow_left.svg" alt="Previous" />
                </div>
                <div ref={nextRef} className={`${styles.customNav} ${styles.customNext}`}>
